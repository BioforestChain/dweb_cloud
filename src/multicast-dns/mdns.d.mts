...
import type { Answer, Packet, Question, RecordType } from "dns-packet";
 ...
 * });
 */
export declare function mDNS(options?: mDNS.Options): mDNS.MulticastDNS;
export declare namespace mDNS {
  interface Options {
    /**
     * Set the UDP port.
     *
  ...
  type QueryCallback = (error: Error | null, bytes?: number) => void;
  type ResponsedCallback = (error: Error | null, bytes?: number) => void;
  ...
  interface MulticastDNS extends EventEmitter {
    ...
    query(query: string, type?: RecordType, callback?: QueryCallback): void;
    query(
      query: string,
      type?: RecordType,
      rinfo?: RemoteInfoOutgoing,
